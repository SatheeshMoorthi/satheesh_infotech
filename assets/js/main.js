...
function navHighlighter()
{
  ...
  // Now we loop through sections to get height, top and ID values of each
...
function color() {
    ...
    if(t1=="w") {
        ...
        checkbox2.addEventListener('change', () => {
          document.body.classList.toggle('color__theme');
        });
        document.getElementById("color").click.innerHTML="Green";
        document.getElementById("t1").value="r";
    }

    if(t1=="r") {
            document.getElementById("color").innerHTML="Red";
            document.getElementById("t1").value="w";
    }
}
